# e76bedaf-fd82-4a79-85c3-770bd6dd9c8a implementation handoff

This archive is the source of truth for turning the design into production code. Start from `control-center-v2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `control-center-v2.html`
...
- A single self-contained `control-center-v2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `control-center-v2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `brand-spec.md`
- `Screenshot-2026-09-19-072953-1.png`
- `Screenshot-2026-09-19-072953.png`
- `Screenshot-2026-09-19-073006-1.png`
- `Screenshot-2026-09-19-073006.png`
- `Screenshot-2026-09-19-073012.png`
- `Screenshot-2026-09-19-073018.png`
- `Screenshot-2026-09-19-073122.png`
- `Screenshot-2026-09-19-073128.png`
- `Screenshot-2026-09-19-073136.png`
- `Screenshot-2026-09-19-084216.png`

## Coding checklist for AI tools
1. Inspect `control-center-v2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
